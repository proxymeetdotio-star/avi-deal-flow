...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "Avi — AI-Native Investment Banking for GCC Private Capital" },
      { property: "og:description", content: "Avi is an AI-native investment bank for GCC private capital markets. Real estate, SME, growth and private credit." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary" },
      { name: "twitter:title", content: "Avi — AI-Native Investment Banking for GCC Private Capital" },
      { name: "twitter:description", content: "Avi is an AI-native investment bank for GCC private capital markets. Real estate, SME, growth and private credit." },
      { property: "og:image", content: "https://pub-bb2e103a32db4e198524a2e9ed8f35b4.r2.dev/1f01117c-d5a8-45a2-9d2e-e893a9b5951b/id-preview-a6a8c27f--11c5f3db-5eba-44e5-80c4-8c1a190956d9.lovable.app-1781239858063.png" },
      { name: "twitter:image", content: "https://pub-bb2e103a32db4e198524a2e9ed8f35b4.r2.dev/1f01117c-d5a8-45a2-9d2e-e893a9b5951b/id-preview-a6a8c27f--11c5f3db-5eba-44e5-80c4-8c1a190956d9.lovable.app-1781239858063.png" },
    ],
